...
export default function Navbar({ NavLink, Link, handdleResponsive, responsive }) {
    ...
    return (
        <header className='w-full top-0 left-0 sticky z-30 bg-white bg-opacity-70 bg-clip-padding backdrop-blur-sm'>
            <div className='flex px-8 py-2 items-center justify-center lg:px-16'>
                ...
                <section className='hidden items-center justify-center space-x-10 font-semibold text-[#8f1b80] md:flex'>
                    ...
                    <a href='https://libreriacristiana.com.co/' target='_blank'>Librería</a>
                    <NavLink to='/donaciones'>Donaciones</NavLink>
                </section>
                <section className='w-full flex items-center justify-end space-x-6'>
                    <button onClick={ handdleToggleSchools } className='hidden px-3 py-1 rounded-lg text-base font-semibold text-white bg-[#8f1b80] transform duration-100 active:scale-110 md:inline'>
                        Escuelas
                    </button>
                    ...
                    <NavLink to='/' className='px-3 py-1 rounded-lg text-base font-semibold text-white bg-[#8f1b80] hover:shadow-md hover:shadow-orange-200 md:hidden'>
                        Contactanos
                    </NavLink>
